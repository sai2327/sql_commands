...
--4
select id,name,date_of_joining,gender
from employee
where gender='Female' and department='Operations';
--5
select name,salary,department
from employee
where gender='Male' and (department='SW' or department='Testing') and SALARY>50000;
--6
select id,name,email,date_of_joining 
from employee
where date_of_joining=NULL;
--7
select * from employee
where department='SW'
and date_of_joining >'01-01-2020';
select *from employee;
--8
select id,name,email,department
from employee 
where email is NULL and department is NULL;
--9
SELECT id, name, gender, department, salary, date_of_joining
FROM employee
WHERE gender = 'Male'
AND department = 'Operations'
AND salary <= 40000
AND date_of_joining < '2023-07-15';
--10
...
AND salary IS NULL;
--11
select id,name,age, 52-age AS years_of_service_left 
from employee
...
CASE 
    ...
    when salary>50000  then 'Medium paid'
    when salary<5000  then 'Low paid '
    else  'can''t be determind'
END as pay_bucket 
from employee;
...
select count(id) from employee where gender='Female' and department='Operations';

select count(*) from employee where email is NULL;

select count(*) from employee 
where department='Testing' 
and date_of_joining > To_DATE('12-7-2019','DD-MM-YYYY');
...
where gender='Female' and  department='Testing';

--3
select count(id) from employee 
where gender='Male' and department='SW';

--4
select name from employee where SALARY>75000
order by age,name;
--5 
select sum(salary) from employee 
where department='HR' and age>=27;
...
--9 
select avg(salary) from employee
where department='Testing' and date_of_joining > '20-9-2019';

--10
select count(*) from employee 
where department='Testing' and salary<45000;
