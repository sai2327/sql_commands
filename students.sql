...
select * from student where branch='AIML' and college='AEC';
select * from student where age=20;
select * from student where branch = 'CSE' or branch = 'AIML';
select * from student where fee > 40000;
select * from student where enrollment_date> TO_DATE('01-01-2020','DD-MM-YYYY');

select * from student
where branch='CSE' 
and enrollment_date< TO_DATE('01-01-2025','DD-MM-YYYY') 
and age> 20
and fee>=30000;
