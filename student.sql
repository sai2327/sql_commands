...
select id,name,age+5 as new_age from student;

select * from student where branch = 'CSE' or branch='DS' or branch='IoT';
select * from student where branch IN('CSE','DS','IoT');
